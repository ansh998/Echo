package com.example.anaworld.echo.Fragments
...
import com.example.anaworld.echo.Adapters.MainScreenAdapter
...
class MainScreenFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        songTittle = view?.findViewById<TextView>(R.id.songTitleMainScreen)
